<?php 
    ...
    // Autoloading ON
    // Carga automática mediante el Autoloader PSR-4
    require_once __DIR__ . '/autoload.php';

    // Importar el código de clases mediante USE
    use App\Northwind\Customer;
    use App\Northwind\Product;
    ...
    <div class="layout d-flex">
        ...
        <main class="flex-grow-1 p-4 p-lg-5">
            <div class="container-fluid">
                <header class="mb-4">
                    <h1 class="display-6 fw-bold mb-3">PHP Autoloading ON</h1>
                ...
                <section class="welcome-panel bg-white p-4 p-lg-5 shadow-sm">
                    <div class="text-start mx-auto" style="max-width: 720px;">
                        <h2>Carga de clases automática con Autoload PSR-4</h2>
                        <br />
