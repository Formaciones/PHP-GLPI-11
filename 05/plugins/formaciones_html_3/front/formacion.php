...
echo "<th>" . __('Equipo', 'formaciones') . "</th>";
...
foreach ($rows as $row) {
    ...
    // Nombre legible del equipo relacionado.
    $computer_name = PluginFormacionesFormacion::getComputerName($row['computers_id'] ?? 0);
    ...
    echo "<td>" . htmlescape($computer_name) . "</td>";
